    ...
    >
      ...
      <View style={styles.content}>
        <Text style={styles.title}>
          Start your Free Trial and gain 2+ hours back
        </Text>
        ...
        <View style={styles.steps}>
          ...
          <View style={styles.step}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepDescription}>
                We'll send you a notification with a report to see how you improved so far
              </Text>
            </View>
          </View>
          ...
          <View style={styles.step}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepDescription}>
                Your subscription will start on day 4. Cancel anytime during the 3-day trial
              </Text>
            </View>
          </View>
        </View>
