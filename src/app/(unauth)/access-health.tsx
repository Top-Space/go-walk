...
export default function AccessHealthScreen() {
    ...
    const handleNext = () => {
        router.push('/(unauth)/access-health-loading')
    }
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            <View style={styles.content}>
                ...
                <Text style={styles.subtitle}>To track your steps on this iPhone, GoWalk will need your permission.</Text>

                <Image source={healthPermissionImage} style={styles.permissionImage} resizeMode='contain' />
            </View>
