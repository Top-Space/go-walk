            ...
            <View style={styles.container}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button title='Get Started' onPress={() => router.push('/(unauth)/question1')} style={styles.button} />
                        <Button title='Sign in' variant='secondary' onPress={() => router.push('/(unauth)/login')} style={styles.signInButton} />
                    </View>
                </View>
            </View>
        </ScrollView>
