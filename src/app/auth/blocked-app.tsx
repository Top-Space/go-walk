        ...
        <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
            <View style={styles.content}>
                ...
                <View style={styles.progressInfo}>
                    <Text style={styles.progressText}>You're almost halfway there - only 5,800 steps left to unlock the app!</Text>

                    <View style={styles.progressBarContainer}>
                        <View style={styles.progressBar}>
                            <LinearGradient colors={[theme.colors.primary, theme.colors.secondary]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressFill, { width: '48%' }]} />
                        </View>
