    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={[styles.footer, { paddingBottom: insets.bottom + 16 }]}>
                <Pressable style={({ pressed }) => [styles.button, selectedApps.length === 0 && styles.buttonDisabled, pressed && styles.buttonPressed]} onPress={handleContinue} disabled={selectedApps.length === 0}>
